...
public record LockButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<LockButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(InetcoreMod.MODID, "lock_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		InetcoreMod.addNetworkMessage(LockButtonMessage.TYPE, LockButtonMessage.STREAM_CODEC, LockButtonMessage::handleData);
	}
}
