...
public record WarpsButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<WarpsButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(InetcoreMod.MODID, "warps_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		InetcoreMod.addNetworkMessage(WarpsButtonMessage.TYPE, WarpsButtonMessage.STREAM_CODEC, WarpsButtonMessage::handleData);
	}
}
