...
import net.fc.techdecor.procedures.OpenPhoneProcedureProcedure;
...
public record OpenPhoneMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<OpenPhoneMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(TechdecorMod.MODID, "key_open_phone"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TechdecorMod.addNetworkMessage(OpenPhoneMessage.TYPE, OpenPhoneMessage.STREAM_CODEC, OpenPhoneMessage::handleData);
	}
}
