...
import net.fc.techdecor.procedures.OpenTabProcedure;
...
public record OpenTabkeyMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<OpenTabkeyMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(TechdecorMod.MODID, "key_open_tabkey"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TechdecorMod.addNetworkMessage(OpenTabkeyMessage.TYPE, OpenTabkeyMessage.STREAM_CODEC, OpenTabkeyMessage::handleData);
	}
}
