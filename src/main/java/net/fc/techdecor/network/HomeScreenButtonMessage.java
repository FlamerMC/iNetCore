...
import net.fc.techdecor.procedures.OpenwarpsProcedure;
...
public record HomeScreenButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<HomeScreenButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(TechdecorMod.MODID, "home_screen_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TechdecorMod.addNetworkMessage(HomeScreenButtonMessage.TYPE, HomeScreenButtonMessage.STREAM_CODEC, HomeScreenButtonMessage::handleData);
	}
}
