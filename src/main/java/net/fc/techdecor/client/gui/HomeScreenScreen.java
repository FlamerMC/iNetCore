...
import net.fc.techdecor.network.HomeScreenButtonMessage;
...
public class HomeScreenScreen extends AbstractContainerScreen<HomeScreenMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("techdecor:textures/screens/home_screen.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.techdecor.home_screen.label_cerizon"), 91, 4, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.techdecor.home_screen.label_kphone"), 5, 4, -1, false);
	}

	@Override
	public void init() {
		super.init();
		button_empty = Button.builder(Component.translatable("gui.techdecor.home_screen.button_empty"), e -> {
			if (true) {
		...
		button_empty1 = Button.builder(Component.translatable("gui.techdecor.home_screen.button_empty1"), e -> {
			if (true) {
